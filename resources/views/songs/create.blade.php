    ...
    <div class="container">
        ...
        <form action="{{ route('songs.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="title" name="title" placeholder="Titolo canzone">
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="editor" name="editor" placeholder="Nome Editore">
            </div>

            <div class="mb-3">
                <label for="length" class="form-label">Lunghezza brano</label>
                <input type="number" class="form-control" id="length" name="length" step="0.01" placeholder="Lunghezza in decimale">
            </div>
